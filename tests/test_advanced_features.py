...
class TestEdgeCases:
    ...
    def test_small_lambda(self):
        ...
        try:
            basis = pylibsparseir.FiniteTempBasis('F', 1.0, 1.0, 1e-4)  # Lambda = 1
            assert basis.size >= 1
    ...
    def test_large_lambda(self):
        ...
        try:
            basis = pylibsparseir.FiniteTempBasis('F', 10.0, 100.0, 1e-6)  # Lambda = 1000
    ...
    def test_singular_value_ordering(self):
        ...
        for statistics in ['F', 'B']:
            for lambda_val in [10, 42]:
                try:
                    basis = pylibsparseir.FiniteTempBasis(statistics, 1.0, lambda_val, 1e-6)
...
class TestMemoryAndPerformance:
    ...
    def test_large_basis_creation(self):
        ...
        try:
            ...
            basis = pylibsparseir.FiniteTempBasis('F', 1.0, 100.0, 1e-8)
